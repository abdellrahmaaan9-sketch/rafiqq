        ...
        <div class="profile-hero">
            <div class="hero-content">
                ...
                <div>
                    ...
                    <p class="profile-sub">Manage your personal information and accessibility details.</p>
                    <div class="quick-links">
                        <a class="quick-link" href="my_bookings.php">📋 My Bookings</a>
                        <a class="quick-link" href="patient_homepage.php">🏠 Home</a>
                        <a class="quick-link" href="map.php">📍 Map</a>
                    </div>
                </div>
            </div>
        </div>
