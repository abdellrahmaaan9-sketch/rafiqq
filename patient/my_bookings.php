        ...
        <?php else: ?>
            <?php foreach ($bookings as $b): ?>
                <?php
                    ...
                    $statusClass = strtolower(trim((string)($b['status'] ?? 'pending')));
                ...
                <div class="booking-card">
                    <div class="top-row">
                        ...
                        <div class="badges">
                            <span class="badge <?= h($statusClass) ?>">
                                <?= h(booking_status_label($b['status'] ?? 'pending')) ?>
                            </span>
                    ...
                    <?php
                        ...
                        $isActive = in_array(strtolower(trim((string)($b['status'] ?? ''))), ['pending','accepted','arrived','in_trip']);
                    ?>
