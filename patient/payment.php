    ...
    try {
        ...
        if (!$currentBooking) {
            ...
            if ($selectedMethod === 'cash') {
                ...
                $success = "Cash payment selected successfully.";
...
$providerName = trim((string)($booking['provider_name'] ?? 'Provider'));
    ...
    <section class="lux-hero">
        <div class="hero-content">
            ...
            <div class="status-wrap">
                <div class="status-pill green"><?= h($bookingStatus) ?></div>
                <div class="status-pill blue"><?= h($paymentMethodLabel) ?></div>
            </div>
        </div>
    ...
    <section class="layout">
        <div class="panel">
            <div class="panel-inner">
                ...
                <p class="panel-sub">Your selected provider and booking details are shown below.</p>
                ...
                <div class="summary-grid">
                    <div class="meta">
                        ...
                        <div class="meta-value">#<?= (int)$booking['booking_id'] ?></div>
                    </div>
                    ...
                    <div class="meta">
                        ...
                        <div class="meta-value">
                            <?= h(!empty($booking['booking_time']) ? substr((string)$booking['booking_time'], 0, 5) : '-') ?>
                            —
                            <?= h(!empty($booking['service_time']) ? substr((string)$booking['service_time'], 0, 5) : '-') ?>
                        </div>
                    </div>
                    ...
                    <div class="meta">
                        ...
                        <div class="meta-value"><?= h($booking['fullname'] ?? '-') ?></div>
                    </div>
                </div>
                ...
                <div class="total-card">
                    ...
                    <div class="secure-mini">
                        <div class="secure-chip">Protected payment</div>
                        <div class="secure-chip">Instant confirmation</div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="form-block" id="visaBlock">
                            <div class="field-grid">
                                ...
                                <div class="field">
                                    ...
                                    <input class="input" type="password" id="cvv" name="cvv" maxlength="4" inputmode="numeric" autocomplete="cc-csc" placeholder="123" value="<?= h($_POST['cvv'] ?? '') ?>">
                                </div>
                            </div>
