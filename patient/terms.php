...
// Store acceptance with digital signature data
if (isset($_POST['accept_terms']) && isset($_POST['signature_data'])) {
    ...
    if ($sigData && str_starts_with($sigData, 'data:image/png;base64,')) {
        // Mark acceptance — store in session and optionally DB
...
// If already accepted in this session, pass through
...
<div class="page">
  ...
  <!-- Header -->
  <div class="tc-header">
    <a href="patient_homepage.php" class="tc-logo">
